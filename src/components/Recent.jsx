...
function Recent() {
  return (
    <div className='recent'>
        ...
        <div className="container flex flex-col lg:flex-row lg:gap-x-10 lg:justify-between">
          <div className='mb-8 lg:w-3/5'>
          ...
          <div className='bg-orange-400 rounded-lg p-8 grid lg:w-2/5'>
